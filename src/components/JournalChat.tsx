...
const JournalChat = () => {
  ...
  useEffect(() => {
    const initialMessage: Message = {
      ...
      text: "Hi there! I'm your Little Bear journal companion. Feel free to share your thoughts with me. I'm here to listen, and everything you write is private.",
      sender: 'bear',
      timestamp: new Date(),
    };
  ...
  const startJournaling = () => {
    ...
    const bearMessage: Message = {
      id: Date.now().toString(),
      text: "Here's a space for you to write freely. When you're done, you can release your thoughts by sending them away. Don't worry, I won't keep them - this is just for you.",
      sender: 'bear',
      timestamp: new Date(),
    };
  ...
  const sendAwayJournal = () => {
    ...
    setTimeout(() => {
      ...
      const bearMessage: Message = {
        id: Date.now().toString(),
        text: "Your thoughts have been released. I hope that helped lighten your mental load. Is there anything else you'd like to talk about?",
        sender: 'bear',
        timestamp: new Date(),
      };
        ...
        <div className="flex gap-2">
          ...
          <div className="flex-1 flex">
            ...
            <button
              ...
              className="bg-white/20 hover:bg-white/30 px-3 rounded-r-md text-white disabled:opacity-50"
            >
              <Send size={18} />
            </button>
          </div>
